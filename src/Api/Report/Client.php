...
namespace Smartymoon\DingTalk\Api\Report;
...
class Client extends BaseClient
{
    ...
    {
        return $this->post('topapi/report/list', $params);
    }
    ...
    {
        return $this->post('topapi/report/template/listbyuserid', [
    ...
    {
        return $this->post('topapi/report/getunreadcount', compact('userid'));
    }
    ...
    {
        return $this->post('topapi/report/statistics', compact('report_id'));
    }
    ...
    {
        return $this->post('topapi/report/statistics/listbytype', [
    ...
    {
        return $this->post('topapi/report/receiver/list', [
    ...
    {
        return $this->post('topapi/report/comment/list', [
            'report_id' => $report_id, 'offset' => $offset, 'size' => $size
        ]);
    }
