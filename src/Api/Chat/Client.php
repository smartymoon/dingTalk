...
namespace Smartymoon\DingTalk\Api\Chat;
...
class Client extends BaseClient
{
    ...
    {
        return $this->getData('chat/getReadList', [
    ...
    {
        return $this->post('chat/create', $params);
    }
    ...
    {
        return $this->post('chat/update', ['chatid' => $chatId] + $params);
    }
    ...
    {
        return $this->getData('chat/get', ['chatid' => $chatId]);
    }
}
