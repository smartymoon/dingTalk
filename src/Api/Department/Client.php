...
namespace Smartymoon\DingTalk\Api\Department;
...
class Client extends BaseClient
{
    ...
    {
        return $this->getData('department/list_ids', compact('id'));
    }
    ...
    {
        return $this->getData('department/get', compact('id', 'lang'));
    }
    ...
    {
        return $this->getData('department/list_parent_depts_by_dept', compact('id'));
    }
    ...
    {
        return $this->getData('department/list_parent_depts', compact('userId'));
    }
    ...
    {
        return $this->post('department/update', compact('id') + $params);
    }
    ...
    {
        return $this->getData('department/delete', compact('id'));
    }
}
